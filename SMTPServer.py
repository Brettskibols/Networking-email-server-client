...
class NWSThreadedServer:
    def __init__(self, host="127.0.0.1", port=12345):
        if smtpDebugging:  # Renamed from __Debug__ added debug bool at top on line 11 to access and prevent error
    ...
    def _configureserver(self):  # Renamed from _configureServer to match Pep-8, check to see if renaming elsewhere
